...
class Directory extends File{
    ...
    public function chmodR($path, $permission) {
        ...
        if (!$this->isFolder($path))
            return $this->chmod($path, $permission);
     ...
     *				"children" => array()
     */
    final public function list($path, $exclude = array(".DS_Store", ".git", ".svn", ".CVS"), $recursive = FALSE, $recursivelimit = 0, $showfiles = FALSE, $sort = TRUE, $long = FALSE) {
     ...
     * @param boolean $long 
     */
    final public function listFind($name, $inPath, $limit = 1, $recursive = FALSE, $recursiveLimit = 0, $showfiles = FALSE, $sort = TRUE, $long = FALSE) {
     ...
     */
    final public function deleteContents($folderpath, $filterByExtension = array() , $filterByName= array() , $filterExcludeMode = TRUE , $recursive = TRUE ){
